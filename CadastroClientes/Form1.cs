...
namespace CadastroClientes
{
    public partial class Form1 : Form
    {
        ...
        public bool Verificador_NovoCliente() // metodo para verificar se os campos do novo cliente est„o preenchidos corretamente
        {
            ...
            {
                label1.Text = "Nome n„o pode estar vazio";
                return false;
            }
            ...
            {
                label1.Text = "Data n„o pode estar vazia";
                return false;
            }
            ...
            {
                label1.Text = "Telefone n„o pode estar vazio";
                return false;
            }
            ...
            {
                label1.Text = "Email n„o pode estar vazio";
                return false;
            }
